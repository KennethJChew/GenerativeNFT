...
def install():
  ...
  #   if is_downloadable(imagenet_1024_yaml_url):
  #     download(imagenet_1024_yaml_url,"vqgan_imagenet_f16_1024.yaml")
    # if is_downloadable(imagenet_1024_ckpt_url):
  ...
  #   if is_downloadable(imagenet_16384_yaml_url):
  ...
  #   if is_downloadable(gumbel_8192_yaml_url):
  #     download(gumbel_8192_yaml_url,"gumbel_8192.yaml")
    # if is_downloadable(gumbel_8192_ckpt_url):
  ...
  #   if is_downloadable(coco_yaml_url):
  #     download(coco_yaml_url,"coco.yaml")
    # if is_downloadable(coco_ckpt_url):
  ...
  if faceshq:
    ...
    if is_downloadable(faceshq_yaml_url):
      download(faceshq_yaml_url,"faceshq.yaml")
    # if is_downloadable(faces_ckpt_url):
  ...
  #   if is_downloadable(wikiart_1024_yaml_url):
  #     download(wikiart_1024_yaml_url,"wikiart_1024.yaml")
    # if is_downloadable(wikiart_1024_ckpt_url):
  ...
  if wikiart_16384:
    ...
    if is_downloadable(wikiart_16384_yaml_url):
      download(wikiart_16384_yaml_url,"wikiart_16384.yaml")
    # if is_downloadable(wikiart_16384_ckpt_url):
  ...
  if sflckr:
    ...
    if is_downloadable(sflckr_yaml_url):
      download(sflckr_yaml_url,"sflckr.yaml")
    # if is_downloadable(sflckr_ckpt_url):
  ...
  if ade20k:
    ...
    if is_downloadable(ade20k_yaml_url):
      download(ade20k_yaml_url,"ade20k.yaml")
    # if is_downloadable(ade20k_ckpt_url):
  ...
  if ffhq:
    ...
    if is_downloadable(ffhq_yaml_url):
      download(ffhq_yaml_url,"ffhq.yaml")
    # if is_downloadable(ffhq_ckpt_url):
  ...
  if celebahq:
    ...
    if is_downloadable(celebahq_yaml_url):
      download(celebahq_yaml_url,"celebahq.yaml")
    # if is_downloadable(celebahq_ckpt_url):
